...
export default {
  ...
  data: (vm) => ({
    ...
    ///////////////////////////////////////
    status: ["accepted", "refused", "New", "updated", "pending"],
    filtredStatus: null,
    dataArr: [],
    newArr: [],
  ...
  methods: {
    ...
    // filterDependingOnStatus(filtredStatus) {
    ...
    // },
    // filterDependingOnLeaveType(filtredType) {
    //   let updatedStatusArr = [];
    //   this.getAllLeaveForProviders.data.resp.forEach((item) => {
    ...
    //   this.dataArr = updatedStatusArr;
    // },
    // async filterDependingOnDateRange(dates) {
    //   await this.actionForGettingAllLeaveWork({
    //     providerUuid: null,
    //     dateFromFiltred: dates[0],
    //     dateToFiltred: dates[1],
    //   });
    // },
    restAll() {
    ...
    async filterMany(filtredStatus, dates, filtredType) {
