<template>
  <div v-if="$store.getters.getterForProfileLoading">
    <v-container>
      <GoBack />
      ...
      <v-row class="justify-center">
        ...
        <div className="reservation-table">
          ...
          <table v-if="getAllWorkingHours.length > 0">
            <thead>
              <tr>
                <th>Day</th>
                <th>From</th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].sunday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].sunday.to }}
                </td>
                <td data-column="ID">
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].monday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].monday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].tuesday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].tuesday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].wednesday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].wednesday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].thursday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].thursday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].friday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].friday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
              ...
              <tr>
                ...
                <td>
                  {{ getAllWorkingHours[0].saturday.from }}
                </td>
                <td data-column="ID">
                  {{ getAllWorkingHours[0].saturday.to }}
                </td>
                <td data-column="ID">
                  <v-btn @click="showUpdateWorkingHoursDialog">Update</v-btn>
                </td>
...
export default {
  ...
  async mounted() {
    try {
      ...
      this.employeeUuidComingFromUrl = "087a5c8-7bf9-4ce9-af24-958465fa380a";
      await this.getEmployees(this.employeeUuidComingFromUrl);
      this.actionForWorkingHours(this.employeeUuidComingFromUrl);
      this.employeeNameInHrPrivate = JSON.parse(
        JSON.stringify(this.info[0].firstName)
      );
      this.employeeIdInHrPrivate = JSON.parse(JSON.stringify(this.info[0].id));
    } catch (e) {
      console.log(e);
    }
  },
  data() {
    return {
      ...
      dialog2: false,
      employeeUuidComingFromUrl: null,
      employeeIdInHrPrivate: "",
      employeeNameInHrPrivate: "",
      cnt: 1,
      cnt2: 1,
    };
  },
  methods: {
    ...mapActions(["getEmployees", "actionForWorkingHours"]),
    ...
    async checkedIn() {
      ...
      //   requestBuilder("providers", "/checkInClicked", "post", {
      //     providerUuid: this.uuidForProviderIn,
      //     employeeName: this.employeeNameInHrPrivate,
      //     EmployeeId: this.employeeIdInHrPrivate,
      //   })
      // )
      await this.$axios
        .post("/hr/checkInClicked", {
          providerUuid: this.employeeUuidComingFromUrl,
          employeeName: this.employeeNameInHrPrivate,
          EmployeeId: this.employeeIdInHrPrivate,
        })
        .then(() => {
    ...
    async checkedOut() {
      this.cnt2 = ++this.cnt2;
      // let path = await this.$axios(
      //   requestBuilder("providers", "/checkOutClicked", "put", {
      //     providerUuid: this.employeeUuidComingFromUrl,
      //     status: "out",
      //   })
      // )
    ...
    payslipbtn() {
      this.$router.push("/hrpages/payslip/" + this.employeeUuidComingFromUrl);
    },
    viewAttendanceBtn() {
      this.$router.push(
        "/hrpages/attendance/" + this.employeeUuidComingFromUrl
      );
    },
  },
  computed: {
    ...mapGetters(["getAllWorkingHours", "info"]),
  },
  watch: {},
  components: {},
};
